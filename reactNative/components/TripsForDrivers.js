...
export default class YakindakiYolcular extends React.Component {
                        ...
                        <View style={{ flexDirection: 'row', marginTop: 5, marginBottom: 5 }}>
                            <View>
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                    <View style={{ width: 100 + '%', marginBottom: 0, marginRight: 1 + '%', padding: 10, backgroundColor: '#FFF', backgroundColor: '#DD4B4E', borderRadius: 5, borderColor: 'red', borderWidth: 1, }}>
                                        <Text style={{ color: '#FFF', fontFamily: 'airbnbCereal-medium', fontSize: 17, textAlign: 'center', marginBottom: 7, }}>Mevcut Durum</Text>
                                        <Text style={{ color: '#CCC' }}>Mevcut Yolculuğunuzun Bilgileri</Text>
 ...
 this.props.propsNav.navigate('HaritaforTripDriver')
                                ...
                                <View style={{ width: 99 + '%', marginBottom: 10, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', flexDirection: 'row' }}>
                                     <View style={{ width: 48 + '%', marginRight: 1 + '%' }}><Button loading={this.state.yolcukBitirButtonLoading} loadingProps={{ color: '#000' }} title='Yolculuğu Bitir' buttonStyle={{ backgroundColor: '#FFF', width: 100 + '%', }} titleStyle={{ color: '#1E1324' }} onPress={()=>this.yolculukBitir()} titleStyle={{fontSize:15,color:'#000'}} containerStyle={{ marginTop: 10, }} icon={<Ionicons name="ios-power" style={{ marginRight: 10 }} size={20} color="#1E1324" />} /></View>
                                <View style={{ width: 48 + '%', marginRight: 1 + '%' }}><Button title='Harita' buttonStyle={{ backgroundColor: '#FFF', width: 100 + '%', }} titleStyle={{ color: '#1E1324' }} onPress={async() => {await AsyncStorage.setItem('yolcuUid',l.from);  this.props.propsNav.navigate('HaritaforTripDriver') }} containerStyle={{ marginTop: 10 }} icon={<Ionicons name="ios-map" style={{ marginRight: 10 }} size={20} color="#1E1324" />} /></View>
                                </View>
                            </View>
