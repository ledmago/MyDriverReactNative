                    ...
                    <View style={{ backgroundColor: '#000000b0', justifyContent: 'center', position: 'absolute', left: 0, top: 0, width: 100 + '%', height: 100 + '%', zIndex: 2 }}>
                        ...
                        <View style={{ borderRadius: 3, padding: 20, backgroundColor: '#FFF', borderColor: '#CCC', borderWidth: 1, width: 99 + '%', height: Dimensions.get('screen').height - 100, alignSelf: 'center' }}>
                            ...
                            <View style={{ marginTop: 100 }}>
                                ...
                                <Button disabled={!this.state.form.valid} onPress={() => CreditCardController.addCreditCard(this.state.form).then((e) => { if (e == 'eklendi') { this.setState({ Modal1Open: false }) } })} title='Ekle' containerStyle={{ marginTop: 40, width: 90 + '%', alignSelf: 'center' }} />
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ backgroundColor: '#000000b0', justifyContent: 'center', position: 'absolute', left: 0, top: 0, width: 100 + '%', height: 100 + '%', zIndex: 2 }}>
                        ...
                        <View style={{ borderRadius: 3, padding: 20, backgroundColor: '#FFF', borderColor: '#CCC', borderWidth: 1, width: 99 + '%', height: Dimensions.get('screen').height - 100, alignSelf: 'center' }}>
                            ...
                            <View style={{ marginTop: 100 }}>
                                ...
                                <Button onPress={() => CreditCardController.deleteCreditCard(this.state.modal2Value).then((e) => { if (e == 'eklendi') { this.setState({ Modal1Open: false }) } })} title='Kartı Sil' containerStyle={{ marginTop: 40, width: 90 + '%', alignSelf: 'center' }} />
                            </View>
                        </View>
                    </View>
