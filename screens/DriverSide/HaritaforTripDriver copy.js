...
export default class HomeScreen extends React.Component {
  ...
  watchPusula = async () => {
    /*await Location.getHeadingAsync((heading) => {
      
    //  this.map.animateToBearing(heading.trueHeading,5000);
    this.map.animateCamera(null,{pitch:50,heading:heading.trueHeading,})
      });*/
  }
  watchHeading = async()=>
  {
    await Location.watchHeadingAsync((heading)=>{
      ...
      this.map.animateToBearing(heading.trueHeading)
    })
  }
